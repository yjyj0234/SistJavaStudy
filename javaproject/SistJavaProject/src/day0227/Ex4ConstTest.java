...
class Banana{
	...
	public Banana(int num) {
		this();     //디폴트 생성자를 다른생성자에서 호출..반드시 첫줄에만
...
public class Ex4ConstTest {
	...
	public static void main(String[] args) {
		...
		// 메서드와 차이점: 클래스명과 같고 리턴형이 존재하지 않음
		// 오버로딩(같은 이름?)이 가능하다(단, 인자는 달라야함)
		
		Orange or=new Orange();
		Apple apple=new Apple("사과");
		Banana banana=new Banana();
		Banana bana=new Banana("오늘은 생성자 배우는 날");
		Banana nana=new Banana(2147483647+1);
	}
