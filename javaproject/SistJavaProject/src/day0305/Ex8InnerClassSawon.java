...
public class Ex8InnerClassSawon {
	...
	public static void main(String[] args) {
		...
		input.inputData();
		//SawonOuter.InputInner input=new SawonOuter().new InputInner();
		//SawonOuter.SudangInner ss=new SawonOuter().new SudangInner();  이렇게 되면 SawonOuter 값이 다시 초기화 되서 null 0이 뜸
