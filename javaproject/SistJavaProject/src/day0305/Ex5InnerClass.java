...
class Outer{
	...
	class Inner1{
		...
		public void disp1() {
			...
			System.out.println("이름: "+name+", 나이: "+age);		//outer에 있는 name age
		}
...
public class Ex5InnerClass {
	...
	public static void main(String[] args) {
		...
		Outer.Inner1 in1=out.new Inner1();                //Outer.new Inner1가 아닌 out.new Inner1
		in1.disp1();
		System.out.println("내부클래스의 disp2호출");
		Outer.Inner2 in2=new Outer().new Inner2();			//new 외부클래스.new 내부클래스
		in2.disp2();
