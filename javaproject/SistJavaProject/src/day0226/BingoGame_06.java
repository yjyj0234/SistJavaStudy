...
public class BingoGame_06 {

	public static void main(String[] args) {
		// 반복문 안에서 엔터를 눌렀을 때 다음 난수가 나오도록 합니다(종료:Q or q)
		/*
		 * 3행 3열의 다차원 배열 생성 후 1~3사이의 난수 발생
		 * 각각의 가로, 세로 대각선을 비교해서 같은값이 나오면 빙고:2개 출력
		 * 없으면 꽝!!! 출력
		 */
