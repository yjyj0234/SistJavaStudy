...
<body>
	...
	<input type="hidden" name="num" value="${dto.num }">
		<table>
			<caption align="top"><b>자동차 정보수정</b></caption>
			<tr>
				<th width="100">차종</th>
				<td>
					<input type="text" name="carname" class="form-control"
					 style="width: 200px;" value="${dto.carname }">
				</td>
			</tr>
			<tr>
				<th width="100">가격</th>
				<td>
					<input type="text" name="carprice" class="form-control"
					 style="width: 200px;" value="${dto.carprice }">
				</td>
			</tr>
			<tr>
				<th width="100">색상</th>
				<td>
					<input type="color" name="carcolor" class="form-control"
					 style="width: 200px;" value="${dto.carcolor }">
				</td>
			</tr>
			<tr>
				<th width="100">구입일</th>
				<td>
					<input type="date" name="guipday" class="form-control"
					 style="width: 200px;" value="${dto.guipday }">
				</td>
			</tr>
			<tr>
